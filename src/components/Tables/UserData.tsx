  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      ...
      <div className="flex flex-col">
        ...
        {userData.map((model, key) => (
          <div
            className={`grid grid-cols-4 ${
              key === userData.length - 1 ? '' : 'border-b border-stroke dark:border-strokedark'
            }`}
            key={key}
          >
          <div className="flex items-center gap-3 p-2.5 xl:p-5">
            ...
            <div className="flex items-center">
              <img src={userData[key % userData.length].image} alt="Product" className="h-8 w-8 rounded-md" />

              <p className="text-black ml-4 dark:text-white">{userData[key % userData.length].name}</p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-center p-2.5 xl:p-5">
              <p className="text-black dark:text-white">{model.role}</p>
            </div>
